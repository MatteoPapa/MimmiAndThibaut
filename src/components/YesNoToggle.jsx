...
const YesNoToggle = ({ name = "presenza", defaultValue = "", onChange }) => {
    const { t } = useLanguage();
    return (
        <form className="animated-inputs radio confirm-scope flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8">
            <div className="sm:flex sm:flex-row gap-10">
                <div className="each sm:w-auto">
                    <input
                        id={`${name}-si`}
                        name={name}
                        type="radio"
